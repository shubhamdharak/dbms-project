        ...
        <div class="row">
          <div class="col-12">
            <div class="list-group text-center">
              <a href="register.php" class="list-group-item active bg-success">Add Members</a>
              <a href="trainer.php" class="list-group-item ">Member details</a>
        ...
        <div class="row">
          <div class="col-12">
            <div class="list-group text-center">
                ...
                <a href="trainer_remove.php" class="list-group-item bg-dark text-white">Remove Trainer</a>      
            </div>
          </div>   
        </div>
